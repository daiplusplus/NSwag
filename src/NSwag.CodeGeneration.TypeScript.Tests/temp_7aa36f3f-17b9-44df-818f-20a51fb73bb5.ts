...
export class UrlEncodedRequestConsumingClient {
    ...
    addMessage(message: Foo | null | undefined, messageId: string | null | undefined, date: Date | undefined, list: string[] | null | undefined): Promise<void> {
    ...
    getMessage(messageId: string | null): Promise<Foo | null> {
        let url_ = this.baseUrl + "/api/UrlEncodedRequestConsuming?";
        if (messageId === undefined)
